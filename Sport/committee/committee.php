...
<a href="committee_add.php"><button type="button" class="btn btn-success" style="margin-left:100px;">+เพิ่มข้อมูลกรรมการ</button></a>
...
<?php
$sql = "SELECT * FROM committee,department where committee.Dep_id=department.Dep_id";
...
<tr>
  ...
  <td style="text-align:center;"><?php echo $row['Committee_id'] ?></td>
    ...
    <td ><h8 style="color: #FF0000"><?php echo $row['Dep_id'] ?></h8>&nbsp;<?php echo $row['Dep_name'] ?></td>
