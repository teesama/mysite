...
<div class="form-group row" style="margin-left:230px;">
    ...
    <div style="margin-left:380px; margin-top:-36px;">
        <button type="submit" class="btn btn-info">ค้นหา</button>
    </div>
  </form>
  </div>
<a href="candidate_add.php"><button type="button" class="btn btn-success" style="margin-left:150px;">+เพิ่มข้อมูลผลการแข่งขัน</button></a>
  <div class="col-lg-4" style="margin-left:900px; margin-top:-10px;">
  </div>
<br>

<center><table class="table table-warning  table-info" style="text-align:center; width:80%">
<tr>
  <td><B>ลำดับที่</td></B>
...
<?php
$sql = "SELECT * FROM candidate_team,team where candidate_team.Team_id=team.Team_id";
...
<tr>
  ...
  <td align="center"><a href="candidate_delete.php?Match_id=<?=$row['Match_id']?>" onclick="return confirm('คุณต้องการลบข้อมูลใช่หรือไม่ ?')" style="text-decoration:none;color:red">[ลบ]</a>
  <a href="candidate_edit.php?Match_id=<?php echo $row['Match_id']?>" style="text-decoration:none;color:blue">[แก้ไข]</a></td>
</tr>
<?php
$i++;
}
